...
$products = $productManager->getRecentProducts();
//xử lý phân trang
    ...
    <main>
        <div class="container">
            ...
            <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="5000">
                        <img src="../assets/img/slide/ms_banner_img1.jpg" class="d-block w-100" alt="...">
                    </div>
            ...
            <div class="text-center">
                <h2 class="show-product-text text-center m-3">Sản phẩm mới nhất</h2>
